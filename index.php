            ...
            <div class="row">
               ...
               <div class="lblinput">
                  ...
                  <select name="khuvuc">
                     ...
                     <option value="1" <?php echo isset($_POST['khuvuc']) && $_POST['khuvuc'] == 1 ? "selected" : ""; ?>>Khu vực 1</option>
                     <option value="2" <?php echo isset($_POST['khuvuc']) && $_POST['khuvuc'] == 2 ? "selected" : ""; ?>>Khu vực 2</option>
                     <option value="3" <?php echo isset($_POST['khuvuc']) && $_POST['khuvuc'] == 3 ? "selected" : ""; ?>>Khu vực 3</option>
                     <option value="4" <?php echo isset($_POST['khuvuc']) && $_POST['khuvuc'] == 4 ? "selected" : ""; ?>>Khu vực 4</option>
                     <option value="5" <?php echo isset($_POST['khuvuc']) && $_POST['khuvuc'] == 5 ? "selected" : ""; ?>>Khu vực 5</option>
                  </select>
               </div>
            </div>
               ...
               <div class="submit">
                  ...
                  <div class="row">
                     ...
                     <div class="lbloutput">
                        <?php
                           if (isset($_POST['btnsubmit'])) {
                               $priority_points = isset($_POST['khuvuc']) ? $_POST['khuvuc'] : 0;
